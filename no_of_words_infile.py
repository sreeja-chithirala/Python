...
for i in range(0,len(data)):
    if data[i]!=' ' and  data[i]!='.' : 
        ...
        i=i+1
        c=c+1     #if we complete moving after a word the c variable gets incremented
    
print("The no of words in the above txt file are ",c)

'''
The data in the file is:  Hi!.My name is Sreeja Chithirala.My roll no is AP20110010321.Iam from CSE section 'E'.
The no of words in the above txt file are  16
'''
